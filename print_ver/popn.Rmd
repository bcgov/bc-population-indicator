...
```{r line_plot, fig.height = 6, fig.width = 10}
```
...
```{r barcharts, fig.height = 7, fig.width = 8}
```

\newpage

```{r plot16, fig.height = 6}
```
...
* The Central Okanagan has seen the largest population increase -- greater than 110% since 1986. Squamish-Lillooet, Fraser Valley, and Nanaimo Regional District have all experienced large increases in population size (greater than 80%).
